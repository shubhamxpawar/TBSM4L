...
export const Music_card = (props) => {
  return (
    <div className='w-full my-1 mx-auto py-2 px-4 bg-slate-800/30 hover:bg-slate-700/50 h-16 flex justify-between text-white rounded-2xl select-none backdrop-blur-xs'>
