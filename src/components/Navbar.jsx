...
export const Navbar = () => {
  ...
  return (
    <div className='mx-auto max-w-auto w-[680px] flex border-1 border-slate-600 bg-stone-900 text-gray-200 rounded-full shadow-xl shadow-black/15'>
      ...
      <NavLink className='hover:shadow-[0_0_40px_5px_rgba(255,255,255,0.1)] transition duration-500 p-2 px-4 py-4 hover:bg-gray-300 delay-100 hover:text-gray-900' to={'/Lunchbreak'}>Lunch Break</NavLink>
